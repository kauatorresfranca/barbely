        ...
        <S.FormularioContainer>
            ...
            <S.Form onSubmit={handleSubmit}>
                <S.inputGroup>
                    ...
                    <input type="text" id="first_name" name="first_name" value={formData.first_name} onChange={handleChange} placeholder="Seu nome" required />
                </S.inputGroup>
                <S.inputGroup>
                    <label htmlFor="last_name">Sobrenome</label>
                    <input type="text" id="last_name" name="last_name" value={formData.last_name} onChange={handleChange} placeholder="Seu sobrenome" required />
                </S.inputGroup>
                <S.inputGroup>
                ...
                <S.inputGroup>
                    ...
                    <div className="input-wrapper">
                        <input type={showPassword ? "text" : "password"} id="password" name="password" value={formData.password} onChange={handleChange} placeholder="Senha" required />
                ...
                <S.inputGroup>
                    ...
                    <div className="input-wrapper">
                        <input type={showConfirmPassword ? "text" : "password"} id="confirmarSenha" name="confirmarSenha" value={formData.confirmarSenha} onChange={handleChange} placeholder="Confirmar senha" required />
                        <i className={showConfirmPassword ? "ri-eye-fill" : "ri-eye-off-fill"} onClick={() => setShowConfirmPassword(!showConfirmPassword)}></i>
                    </div>
                </S.inputGroup>
                <button type="submit">Cadastrar</button>
                <Link to={`/barbearia/${slug}/login`}><span>Já possui cadastro?</span> Faça login</Link>
            </S.Form>
        </S.FormularioContainer>
    );
};
