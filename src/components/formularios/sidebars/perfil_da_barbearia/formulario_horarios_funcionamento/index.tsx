      ...
      try {
        ...
        if (response.ok) {
          ...
          const horariosFormatados = diasDaSemana.map((dia, index) => {
            ...
            return {
              dia,
              aberto: horario && horario.horario_abertura && horario.horario_fechamento ? true : false,
              abre_as: horario && horario.horario_abertura ? horario.horario_abertura.slice(0, 5) : "",
              fecha_as: horario && horario.horario_fechamento ? horario.horario_fechamento.slice(0, 5) : "",
            };
          });
